...
def Generator():
    ...
    down_stack = [
        ...
        downsample(64, 3), # (bs, 128, 128, 64)
        downsample(64, 3), # (bs, 64, 64, 128)
        downsample(128, 3), # (bs, 32, 32, 128)
        downsample(128, 3), # (bs, 16, 16, 256)
        downsample(256, 3), # (bs, 8, 8, 256)
        downsample(256, 3), # (bs, 4, 4, 512)
        downsample(256, 3), # (bs, 4, 4, 512)
    ]

    up_stack = [
        upsample(256, 3, apply_dropout=True), # (bs, 2, 2, 1024)
        upsample(256, 3, apply_dropout=True), # (bs, 4, 4, 1024)
        upsample(128, 3, apply_dropout=True), # (bs, 8, 8, 512)
        upsample(128, 3), # (bs, 16, 16, 512)
        upsample(64, 3), # (bs, 32, 32, 256)
        upsample(64, 3), # (bs, 64, 64, 256)
        upsample(32, 3), # (bs, 128, 128, 128)
    ]
